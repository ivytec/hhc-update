...
中/英文菜单
:   支持中文和英文菜单，且每项菜单中均有对应的帮助说明，详细介绍该项功能的含义及使用方式，使仪表配置更加简单易懂；菜单结构与罗斯蒙特475一致，可根据使用习惯快捷的切换手操器菜单语言。
...
支持仪表全面
:   支持进口、国产各种智能压力、温度、流量、物位变送器的组态、标定、诊断、维护、监视。(进口厂家如罗斯蒙特、E+H。国内厂家如肯特、北京华控、江苏华海、富沃得等。常用设置：单位、量程、空满标、微调、信号发生器、小信号切除、传感器类型修改等)。
